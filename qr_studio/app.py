...
def main(page: ft.Page) -> None:
    ...
    def refresh_preview_if_possible() -> None:
        ...
        try:
            ...
            # Color changes should never interrupt the form interaction.
            return
    ...
    def adapt_to_viewport(_: ft.PageResizeEvent | None = None) -> None:
        ...
        # Keep the desktop app inside the visible screen while still allowing
        # narrow/small viewports to scroll internally instead of overflowing.
